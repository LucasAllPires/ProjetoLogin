...
//MIDOLEWEAR QUE VAI PROTEGER AS ROTAS DA API E GARANTIR QUE APENAS USUARIOS COM O TOKEN VALIDO POSSA ACESSAR
...
app.get("/dashboard", (req,res)=>{
    req.json({message:"Acesso autorizado, Bem-vindo.", user:req.user})
})
